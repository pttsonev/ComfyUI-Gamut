...
if __package__:
    ...
    from .nodes.core_nodes import (
        GamutColorSpaceConvert, GamutNormalDecode, GamutNormalEncode, GamutTransfer,
    )
    from .nodes.info_nodes import GamutColorSpaceInfo
    from .nodes.io_nodes import (
        GamutLoadDataEXR, GamutLoadEXR, GamutSaveDataEXR, GamutSaveEXR,
        GamutSaveHighBit, GamutSaveMultilayerEXR,
    )
...
NODE_CLASS_MAPPINGS = {
    ...
    "GamutNormalDecode": GamutNormalDecode,
    "GamutNormalEncode": GamutNormalEncode,
    "GamutLoadEXR": GamutLoadEXR,
    "GamutLoadDataEXR": GamutLoadDataEXR,
    "GamutSaveMultilayerEXR": GamutSaveMultilayerEXR,
    "GamutSaveEXR": GamutSaveEXR,
    "GamutSaveDataEXR": GamutSaveDataEXR,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "GamutNormalDecode": "Gamut: Normal Decode",
    "GamutNormalEncode": "Gamut: Normal Encode",
    "GamutLoadEXR": "Gamut: Load EXR",
    "GamutLoadDataEXR": "Gamut: Load Data EXR",
    "GamutSaveMultilayerEXR": "Gamut: Save Multilayer EXR",
    "GamutSaveEXR": "Gamut: Save EXR",
    "GamutSaveDataEXR": "Gamut: Save Data EXR",
